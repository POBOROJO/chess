      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {steps.map((step, index) => (
            <div key={index} className="text-center relative">
              ...
              <div className="relative z-10">
                ...
                <h3 className="font-heading text-lg sm:text-xl font-semibold mb-2 sm:mb-3 text-primary-dark tracking-tight">
                  {step.title}
                </h3>
                <p className="font-body text-sm sm:text-base text-gray-text font-light leading-relaxed tracking-wide">
                  {step.description}
                </p>
              </div>
            </div>
        ...
        <div className="text-center mt-12">
          <button
            ...
            className="font-display bg-primary-dark hover:bg-primary-light text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg text-base sm:text-lg font-semibold hover-lift transition-all duration-300 tracking-wide"
          >
